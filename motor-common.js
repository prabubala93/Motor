...
function showError(msg) {
  ...
  document.getElementById("resultPanel").innerHTML = `<div class="error-text">${msg}</div>`;
...
function renderResult(r) {
  ...
  document.getElementById("resultPanel").innerHTML = `
    <div class="result-total"><span class="currency">₹</span>${fmt(r.finalPremium)}</div>
    ...
    <div class="result-row emphasis"><span>OD Subtotal</span><span class="val">₹${fmt(r.odSubtotal)}</span></div>
    <div class="result-row"><span>GST on OD (18%)</span><span class="val">₹${fmt(r.odTax)}</span></div>
    <div class="result-row emphasis"><span>Own Damage Total</span><span class="val">₹${fmt(r.odTotal)}</span></div>
    ...
    <div class="result-row emphasis"><span>Third-Party Total</span><span class="val">₹${fmt(r.tpTotal)}</span></div>
    <div class="result-row emphasis"><span>FINAL PREMIUM</span><span class="val">₹${fmt(r.finalPremium)}</span></div>
  `;
